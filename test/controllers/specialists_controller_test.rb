...
class SpecialistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialist" do
    assert_difference('Specialist.count') do
      post specialists_url, params: { specialist: { description: @specialist.description, name: @specialist.name, phone: @specialist.phone, text: @specialist.text } }
    end
  ...
  test "should update specialist" do
    patch specialist_url(@specialist), params: { specialist: { description: @specialist.description, name: @specialist.name, phone: @specialist.phone, text: @specialist.text } }
